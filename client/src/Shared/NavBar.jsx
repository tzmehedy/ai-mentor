...
const NavBar = () => {
    return (
      <div className="fixed z-40 w-full px-20  flex justify-between items-center mt-10">
        <div>
        ...
        <div className="text-white text-lg hidden lg:inline-block">
          <button className=" border-2 border-white px-3 py-2 rounded-lg cursor-pointer hover:bg-[#3500FC] hover:border-[#3500FC]">
            Login
          </button>
        </div>
